...
test('formats messages for invalid number schemas with multiple-of validation correctly', function () {
    const multipleOf = 2;
    const input = 7;
...
test('formats messages for invalid bigint schemas with multiple-of validation correctly', function () {
    const multipleOf = 2n;
    const input = 7n;
